...
//
// ASCOM Switch driver for FanControl
//
...
namespace ASCOM.FanControl.Switch
{
    ...
    //
    // Your driver's DeviceID is ASCOM.FanControl.Switch
    //
    // The COM Guid attribute sets the CLSID for ASCOM.FanControl.Switch
    // The COM ClassInterface/None attribute prevents an empty interface called _FanControl from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("7cea2676-5525-4fbc-bbb0-226e7bccccec")]
    [ProgId("ASCOM.FanControl.Switch")]
    [ServedClassName("ASCOM Switch Driver for FanControl")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Switch : ReferenceCountedObjectBase, ISwitchV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FanControl"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Switch()
        {
            try
            {
                ...
                tl = new TraceLogger("", "FanControl.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.FanControl.Switch", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void Connect()
        {
            try
            {
                ...
                SwitchHardware.Connect(uniqueId);
            }
            catch (Exception ex)
            {
        ...
        public void Disconnect()
        {
            try
            {
                ...
                SwitchHardware.Disconnect(uniqueId);
            }
            catch (Exception ex)
            {
